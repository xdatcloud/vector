...
RUN apt-get update && apt-get -y install build-essential git clang cmake libatomic-ops-dev libclang-dev libsasl2-dev libstdc++-10-dev libssl-dev libxxhash-dev zlib1g-dev zlib1g
