...
use codecs::{encoding::Framer, CharacterDelimitedEncoder, NewlineDelimitedEncoder};
...
impl AzureBlobSinkConfig {
    pub fn build_processor(
        ...
        let framer = match (framer, &serializer) {
            ...
            (None, codecs::encoding::Serializer::Json(_)) => {
                CharacterDelimitedEncoder::new(b',').into()
            }
            (None, codecs::encoding::Serializer::RawMessage(_)) => {
